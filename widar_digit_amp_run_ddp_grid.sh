...
BASE_EXP_NAME="/home/cxy/data/code/datasets/sense-fi/Widar_digit_amp/EXP/amp_rate_mask_trafficlike_no_rec_but_linear_interp__20260204_224417"
use_energy_input=0
#use_mask_0=1
#is_rec=1
#istanet csdc
...
TEST_ONLY=1
CKPT_PATH="/home/cxy/data/code/datasets/sense-fi/Widar_digit_amp/EXP/amp_rate_mask_trafficlike_no_rec_but_linear_interp__20260204_224417/Model Parameters/method_trafficlike/rate_0.05/interp_linear/ResNet18/best_model.pth"
# 1=按采样率评测；1=按BGI分桶评测
EVAL_RATE=1
EVAL_BGI=1
